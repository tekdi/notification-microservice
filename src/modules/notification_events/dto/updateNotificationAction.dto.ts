...
export class EmailUpdateDto {
  ...
  @ApiProperty({ example: 'test', description: 'Email from name' })
  @IsString()
  @IsNotEmpty()
  @IsOptional()
...
export class PushUpdateDto {
  ...
  @ApiProperty({
    example: 'Updated push body content',
  ...
  @ApiProperty({
    example: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c',
  ...
  @ApiProperty({ example: 'https://test.org/learn', description: 'Link URL' })
  @IsString()
  @IsOptional()
  link: string;
}
...
export class UpdateNotificationActionDto {
  ...
  @ApiProperty({
    example: 'published',
    description: 'Status for NotificationActions',
  })
  ...
  @ApiProperty({
    example: 'published',
    description: 'Status for NotificationActionTemplates',
  })
  @IsEnum(['published', 'unpublished'], {
  ...
  @ApiProperty({
    type: PushUpdateDto,
    description: 'Push notification update details',
  })
  @ValidateNested()
  @Type(() => PushUpdateDto)
  @IsOptional()
